...
class CustomerTest extends TestCase
{
    ...
    /**
     * @depends testAddDefaultCustomerCardFromCardDetails
     * @group   ecommerce
     */
    public function testDeleteCustomerCard($customer)
    {
        $customerToken = $customer->token;
        ...
        $this->mockResponse($this->successDeleteCustomerCardResponse());
        $customer = Customer::delete($customerToken, $data);

        $this->assertEquals(2, $customer->cards->count);
        $this->assertEquals(2, count($customer->cards->data));

        $cards = array_map(function ($c) {
            return $c->token;
        }, $customer->cards->data);

        $this->assertFalse(in_array($noDefaultCard->token, $cards));
    }
    ...
    private function successDeleteCustomerCardResponse()
    {
        return '{ "description": null, "email": "john_dow@example.com", "date_created": "2016-05-24T15:27:01+0300", "full_name": "John Doe", "token": "cus_5xF3gMMjfbDIJsjW6AU2iKXt", "is_active": true, "date_modified": "2016-05-24T15:27:06+0300", "cvv_required": false, "card": { "token": "crd_YIVfs6byjPo22J36woXGuxer", "expiration_month": "01", "expiration_year": "2017", "last_four": "9343", "type": "MasterCard", "holder_name": "John Doe", "supports_installments": false, "max_installments": 0, "status": "valid", "friendly_name": "MasterCard •••• 9343 (01\/2017)", "cvv_required": false }, "cards": { "count": 2, "data": [ { "token": "crd_YIVfs6byjPo22J36woXGuxer", "expiration_month": "01", "expiration_year": "2017", "last_four": "9343", "type": "MasterCard", "holder_name": "John Doe", "supports_installments": false, "max_installments": 0, "status": "valid", "friendly_name": "MasterCard •••• 9343 (01\/2017)", "cvv_required": false }, { "token": "crd_qnvHpguELOsgavIn9YUH96Gv", "expiration_month": "01", "expiration_year": "2017", "last_four": "1111", "type": "Visa", "holder_name": "John Doe", "supports_installments": true, "max_installments": 12, "status": "valid", "friendly_name": "Visa •••• 1111 (01\/2017)", "cvv_required": false } ] } }';
    }
}
